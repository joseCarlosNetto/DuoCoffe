...
export const hero = {
  ...
  images: {
    ...
    detail: { src: "hero-detail", alt: "Cappuccino da Duo Coffee com arte em cima da mesa" },
  },
};
...
export const coffeeStory = {
  ...
  images: {
    main: { src: "coffee-story-main", alt: "Espresso servido ao lado de uma sobremesa da casa" },
    detail: {
      src: "coffee-story-detail",
      alt: "Bebida gelada da casa servida em taça sobre a mesa",
    },
  },
};
...
export const experience = {
  ...
  gallery: [
    ...
    {
      image: { src: "experience-4", alt: "Integrante da equipe da cozinha da Duo Coffee" },
      colSpan: 4,
      rowSpan: 2,
    },
    {
...
export const location = {
  ...
  mapLabel:
    "Mapa estilizado da localização da Duo Coffee na Rua José Bongiovani, Vila Liberdade",
